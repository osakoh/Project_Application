...
def tweetText():
    global textfile
    current_path = "./data/"
    textfile = filedialog.askopenfilename(title='Choose text file',
...
def tweetValues():
    global valuefile
    current_path = "./data/"
    valuefile = filedialog.askopenfilename(title='Choose value file',
                                             initialdir=current_path,
                                             filetypes=[("CSV files", "*.csv")])
...
def testTweetText():
    global textfile
    current_path = "./data/"
    textfile = filedialog.askopenfilename(title='Choose text file', initialdir=current_path, filetypes=[("CSV files",
                                                                                                           "*.csv")])
...
def testTweetValues():
    global valuefile
    current_path = "./data/"
    valuefile = filedialog.askopenfilename(title='Choose value file', initialdir=current_path, filetypes=[("CSV files"
                                                                                                             ,
                                                                                                             "*.csv")])
...
def evaluateTweetText():
    global textfile
    current_path = "./data/"
    textfile = filedialog.askopenfilename(title='Choose text file for evaluation', initialdir=current_path,
                                            filetypes=[("CSV files", "*.csv")])
